...
class Car:
    ...
    def move(self, df, a):
        ...
        self.beta = np.arctan((self.lr / (self.lf + self.lr)) * np.tan(df))
...
class Jaywalker:
    ...
    def __init__(self):
        ...
        self.max_obstacles = 1  # massimo numero di ostacoli
        ...
        self.a = [-2, 0, 2] # acceleration (deceleration, no acceleration, acceleration)
        ...
        self.state_size = 8 # [car position, distance from jaywalker, angle w.r.t. jaywalker, speed, steering angle]
        self.action_size = self.num_df_actions * self.num_a_actions # number of actions

        self.max_iterations = 15000 # episode terminates after this number of steps
        ...
        self.sight = 60 # sight range: how far the car can see in front of it
